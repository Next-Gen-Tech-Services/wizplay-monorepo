...
class ServerConfigs {
  ...
  static DATABASE_NAME: string = process.env.USER_DATABASE_NAME as string;
  static DATABASE_USERNAME: string = process.env.USER_DATABASE_USERNAME as string;
  static DATABASE_PASSWORD: string = process.env.USER_DATABASE_PASSWORD as string;
  static DATABASE_HOST: string = process.env.USER_DATABASE_HOST as string;
  static DATABASE_PORT: string = process.env.USER_DATABASE_PORT as string;
