...
class ServerConfigs {
  ...
  static KAF_CLIENT_ID: string = process.env.AUTH_KAF_CLIENT_ID || process.env.KAF_CLIENT_ID as string;
  static KAF_GROUP_ID: string = process.env.AUTH_KAF_GROUP_ID || process.env.KAF_GROUP_ID as string;
